...
<head>
  ...
  <script type="text/javascript" src="../proyeccionAdmin/js/app.js"></script>
...
<body>
  ...
  <div class="bienvenida" style="font-size:20px; text-decoration: none; padding-bottom:10px;
    ...
    <?php } else {
      header('Location: /proyecto/php-login/login.php');
    }
    ?>

    <a class="evento" href="http://localhost/proyecto/php-login/logout.php" onclick="return Confirmar('¿Realmente deseas cerrar sesión?');">
      <b>Cerrar Sesión</b>
    </a>
