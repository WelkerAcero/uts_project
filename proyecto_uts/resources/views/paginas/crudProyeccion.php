                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                ...
                                <?php if ($txtFoto != "") { ?>
                                    <img class="img-thumbnail rounded mx-auto d-block" width="100px" src="../../../Sistema/Imagenes/ <?php echo $txtFoto; ?>" /><br>
                                    <br>
                                <?php } ?>
        ...
        <div class="row">
            <table class="table table-hover table-bordered">
                ...
                <?php foreach ($listaproyeccion as $project) { ?>
                    <tr>
                        <td><img class="img-thumbnail" width="100%" src="../../../Sistema/imagenes/<?php echo $project['Foto']; ?>" /></td>
